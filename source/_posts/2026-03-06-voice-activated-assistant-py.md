---
title: 🎙️ voice-activated-assistant.py
...
**🎙️ 語音互動助理 (Voice-Activated Assistant) - 高效能、隱私優先的本地端語音代理系統**
...
- [📝 專案待辦事項 (TODO.md)](https://github.com/chiisen/voice-activated-assistant.py/blob/main/TODO.md)：包含各階段 (Phase 1-8) 的詳細實作清單與驗收標準。
- [📄 產品需求文件 (PRD.md)](https://github.com/chiisen/voice-activated-assistant.py/blob/main/PRD.md)：系統架構與演算法細節的權威定義。
...
✅高效能、隱私優先的本地端語音代理系統，體驗流暢的語音指令識別，歡迎 Star 🌟！
